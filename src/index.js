...
function generateResponse(event) {
  ...
  responseContainer.innerHTML = `<div class="blink"> The voice from the shadows is about to speak...</div>`;

  let userInput = document.querySelector("#user-input").value;
  let apiKey = "of26b55307144beab6f326a4tefcaa5e";
  let prompt = `You are a mystical fortune teller channeling the spirit of ${userInput}. Begin by briefly summarizing their core ideas and philosophy as if the philosopher themselves were reflecting on their legacy. Then, speak in the philosopher's voice but filtered through a fortune teller's mysterious, slightly ironic tone. Let the philosopher grapple with how their ideas hold up in today's chaotic world—acknowledging where they missed the mark, where they still shine, and how their principles collide with modern society, technology, politics, and ethics. Keep it witty, darkly comic, and skeptical. Limit the response to under 1000 characters. Use this blend to question, challenge, and contextualize the philosopher's views through the fortune teller's eyes. Keep the language simple as for 15-18 years old.`;
